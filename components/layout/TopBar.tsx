      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-9 text-xs">
          ...
          <div className="flex items-center gap-3 ml-auto">
            ...
            >
              <span>📞</span>
              <span className="hidden sm:inline">+1 (332) 272-8148</span>
            ...
            <a
              ...
              target="_blank" rel="noopener noreferrer"
              className="hidden sm:flex items-center gap-1.5 text-muted hover:text-pink-400 transition-colors"
            >
              <InstagramIcon />
              <span>@apextcg_warehouse</span>
            </a>
          </div>
        </div>
      </div>
